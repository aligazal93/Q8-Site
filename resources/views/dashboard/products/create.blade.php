        ...
        <div class="col-sm-12">
          ...
          <form action="{{ url('dashboard/products') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <input type="text" name="name" placeholder="Enter Product Name" class="form-control mb-2" value="{{old('name')}}">
              ...
              <div class="form-group">
                  <input type="text" name="price" placeholder="Enter Product price" class="form-control mb-2" value="{{old('price')}}">
