            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:20px" >
                   <a class="btn btn-primary" href="/slides/{{$slide->id}}/edit"> <i class="fa fa-edit" title="Edit"></i> </a>
                   <form action="{{url('/slides/'.$slide->id)}}" method="POST">
                     @method('DELETE')
                       @csrf
                     <button type="submit" class="btn btn-danger" title="DELETE" > <i class="fa fa-trash"></i></button>
                  </form>
                  <a class="btn btn-secondary" href="/slides/{{$slide->id}}"> <i class="fa fa-eye" title="Show"></i> </a>
                </td>
              </tr>
