          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-toggle="dropdown">
                <span class="avatar" style="background-image: url({{ asset('uploads/users/'.Auth::user()->image) }})"></span>
            ...
            <div class="container-xl">
			  ...
			  <li class="nav-item dropdown">
			   ...
			   <li class="nav-item dropdown">
				  ...
				  <a class="dropdown-item" href="{{ url('dashboard/about/edit') }}"><i style="margin-right:5px" class="fa fa-eye"></i> Edit</a>
                  </div>
               </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ url('dashboard/slides') }}">All Slides</a>
                    <a class="dropdown-item" href="{{ url('dashboard/slides/create') }}"><i style="margin-right:5px" class="fa fa-plus"></i> Create a New Slide</a>
                  </div>
               </li>
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ url('dashboard/categories') }}">All Category</a>
                    <a class="dropdown-item" href="{{ url('dashboard/categories/create') }}"><i style="margin-right:5px" class="fa fa-plus"></i> Create a New Category</a>
                  </div>
               </l4i>
               ...
               <li class="nav-item dropdown">
                   ...
                   <div class="dropdown-menu">
                     <a class="dropdown-item" href="{{ url('dashboard/brands') }}">All Brands</a>
                     <a class="dropdown-item" href="{{ url('dashboard/brands/create') }}"><i style="margin-right:5px" class="fa fa-plus"></i> Create a New Brand</a>
                   </div>
                </li>
				...
				<li class="nav-item dropdown">
                   ...
                   <div class="dropdown-menu">
                     <a class="dropdown-item" href="{{ url('dashboard/users') }}">All Users</a>
                     <a class="dropdown-item" href="{{ url('dashboard/users/create') }}"><i style="margin-right:5px" class="fa fa-plus"></i> Create a New User</a>
				...
				<li class="nav-item dropdown">
                   ...
                   <div class="dropdown-menu">
                     <a class="dropdown-item" href="{{ url('dashboard/products') }}">All Products</a>
                     <a class="dropdown-item" href="{{ url('dashboard/products/create') }}"><i style="margin-right:5px" class="fa fa-plus"></i> Add a New Product</a>
