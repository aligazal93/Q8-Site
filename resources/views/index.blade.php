        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="the-category-bag">
                            <p>الشنط</p>
                        </div>
                    </div>

                    <div class="col-sm-6 col-xs-12">
                        <div class="the-category-accessoires">
                            <p>الاكسسوارات</p>
                        </div>
                    </div>

                    <div class="col-sm-6 col-xs-12">
                        <div class="the-category-offer">
                            <p>العروض</p>
                        </div>
                    </div>
                </div><!--col-sm-8-->
    ...
    <div class="subscribe">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <div class="sub-txt">
                        <h4><i class="fas fa-paper-plane"></i> سجل معنا ليصلك جديدنا</h4>
                    </div>
                </div><!--col-sm-6-->
